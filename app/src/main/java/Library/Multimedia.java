...
public class Multimedia {
    ...
    public void cropCapturedImage(int action){
        ...
        switch (action){
            case 0:
                ...
                //los limites de la imagen a cortar
        ...
        if(0 == list.size()){
            ...
            //true: retorna la imagen como un bitmap, false: retorna la url de la imagen guardada
    ...
    public byte[] ImageByte(ImageView imageView){
